...
gs <- as.matrix(read.delim("C:/Users/Fang/Google Drive/Science/BreastCancer_AA Project/WorkSpace/METABRIC/0_Genesets/PATHIFIER_genesets_apop_autop.gmt", header = F))

# Get logFCH for selected genes
genes <- unique(as.character(gs[,-1:-2]))
...
# Mapping in KEGG diagrams | Apoptosis KEGGid 04210 | Autophagy KEGGid 04140
